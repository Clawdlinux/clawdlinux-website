...
const TIMELINE = [
  ...
  },
  {
    ...
    detail: 'Agentic Operator is the operational layer. It sits between your agent framework and your K8s cluster. One CRD to deploy, one protocol for agents to talk, one bill per workload.',
  },
  {
    phase: 'Moat',
    ...
    >
      ...
      >
        ...
        >
          ...
          Agentic Operator fills that gap — the Kubernetes-native control plane for autonomous AI agents.
        </p>
      </motion.div>
